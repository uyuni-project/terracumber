...
class TestUtils(unittest.TestCase):
    def test_read_config(self):
        ...
        variables = { "URL_PREFIX": "https://ci.suse.de/view/Manager/view/Uyuni/job/uyuni-master-cucumber-pipeline-NUE",
                      ...
                      "MAIL_TEMPLATE": "test/resources/templates/mail-template-jenkins.txt",
                      "MAIL_SUBJECT_ENV_FAIL": "Results Uyuni-Master: Environment setup failed",
                      "MAIL_TEMPLATE_ENV_FAIL": "test/resources/templates/mail-template-jenkins-env-fail.txt",
                      "MAIL_FROM": "galaxy-ci@suse.de",
                      "MAIL_TO": "juliogonzalez@localhost",
                      "GIT_USER": "null",
                      "GIT_PASSWORD": "null" }
        self.maxDiff = None
        self.assertDictEqual(config.read_config('test/resources/test.tf'), variables)
